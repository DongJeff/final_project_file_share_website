        ...
        <div class="download">
            ...
            <div class="common-box">
                ...
                extract
                    ...
                    <div v-else>
                        <p class="download-tip">
                            Pay attention to the special symbols that distinguish the Chinese and English input methods
                            You need to enter the file suffix to extract correctly
                        </p>
                        <div class="extract-method">
    ...
    export default {
        ...
        methods: {
            downloadByShareCode() {
                ...
                this.axios({
                    method: 'get',
                    url: axios.defaults.baseURL + api.download + '?share_code=' + this.key,
                    responseType: "blob"
                }).then(res => {
                    // console.log(res)
